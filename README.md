# Rezero API 功能
Rezero是一款.NET中间件,无需写代码也能实现CRUD，非.NET用户可以用发布好的exe文件 

1、界面创建接口 、界面建库、界面建表 、界面生成接口、界面设置授权、界面生成接口文档、界面调试接口等等<br>
2、拥有完整的授权界面和配置文件,可以创建自已的用户表，而不是固定的表实现授权<br>
3、.NET用户只要是.NET6+的API项目都可以一行代码集成到自已项目中<br>
