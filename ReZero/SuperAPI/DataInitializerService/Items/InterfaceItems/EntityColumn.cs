            ...
            ZeroInterfaceList data5 = GetNewItem(it =>
            {
                ...
                it.DataModel = new DataModel()
                {
                    ...
                    DefaultParameters = new List<DataModelDefaultParameter>()
                    {
                        ...
                        new DataModelDefaultParameter() { Name=nameof(ZeroEntityColumnInfo.Length),ValueType = typeof(int).Name },
                        new DataModelDefaultParameter() { Name=nameof(ZeroEntityColumnInfo.DecimalDigits),ValueType = typeof(int).Name },
